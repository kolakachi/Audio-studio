...
<div class="main-col-content" id="agency-teams">
  @csrf
    <h1 class="page-title">Agency</h1>

    <div class="page-tab-nav">
      <div class="btn-group">
        <a href="{{ route('user.agency') }}" class="btn btn-primary" aria-current="page">Assets</a>
        <a href="{{ route('user.agency.teams') }}" class="btn btn-primary active">Teams</a>
      </div>
    </div>


    <div class="agency-teams">
      <div class="d-flex justify-content-between align-items-center mb-5">
        <h4>All Team Members</h4>

        <button class="btn btn-primary px-4" data-bs-toggle="modal" data-bs-target="#agencyNewUser">
          + Team Member
        </button>
      </div>
    ...
    <div class="modal fade new-user-modal" id="agencyNewUser" tabindex="-1" aria-labelledby="agencyNewUserLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-body">
            <h4 class="new-user-heading">Add Team Member</h4>
    
            <div class="new-user-modal-tabs">
              <div class="btn-group">
                <button class="btn btn-primary border-0 active">
                  Team Member Details
                </button>
              </div>
            </div>
              ...
              <div class="new-user-form-row">
                ...
                <div class="new-user-form-col">
                  <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="role" value="Team Member" disabled>
                  </div>
                </div>
              </div>
              <div class="new-user-form-row">
    ...
    <textarea style="display:none" id="user-create" cols="30" rows="10">{{ route('user.agency.account.add') }}</textarea>
    <textarea style="display:none" id="user-delete" cols="30" rows="10">{{ route('user.agency.account.delete') }}</textarea>
    <textarea style="display:none" id="update-details" cols="30" rows="10">{{ route('user.agency.account.update.details') }}</textarea>
    ...
    <textarea style="display:none" id="update-password" cols="30" rows="10">{{ route('user.agency.account.update.password') }}</textarea>
</div>
...
<script src="{{ asset('js/app/agency-teams.js') }}"></script>
@endsection