...
@csrf
    ...
    <div class="whitelabel-users">
      ...
      <div class="table-actions">
         <input type="text" class="form-control search-input" placeholder="Search for Audio" @keyup="searchUser" v-model="searchQuery">       
      </div>
          ...
          <tbody>
            <tr v-for="(user, index) in users">
              ...
              <td class="actions">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#subscriptionModal" @click="editSubscriptions(user)" class="btn">
          ...
          <div class="modal-content">
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs mb-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="subscriptions-tab" data-bs-toggle="tab" data-bs-target="#subscriptions" type="button" role="tab" aria-controls="subscriptions" aria-selected="true">Subscriptions</button>
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm" v-model="userEdit.role">
                                <option value="member">Member</option>
                                <option value="admin">Admin</option>
                                <option value="support">Support</option>
                                <option value="reviewer">Reviewer</option>
    ...
    <div class="modal fade new-user-modal" id="subscriptionModal" tabindex="-1" role="dialog" aria-labelledby="auduienceModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
          <div class="modal-content">
            <div class="pr-2 pt-2">
              {{-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<textarea style="display:none" id="user-create" cols="30" rows="10">{{ route('super-user.users.add') }}</textarea>
<textarea style="display:none" id="user-delete" cols="30" rows="10">{{ route('super-user.users.delete') }}</textarea>
<textarea style="display:none" id="update-details" cols="30" rows="10">{{ route('super-user.users.update') }}</textarea>
<textarea style="display:none" id="update-subscriptions" cols="30" rows="10">{{ route('super-user.users.update-sub') }}</textarea>
<textarea style="display:none" id="update-password" cols="30" rows="10">{{ route('super-user.users.update-password') }}</textarea>
<textarea style="display:none" id="user-search-url" cols="30" rows="10">{{ route('super-user.users.search') }}</textarea>
@endsection
