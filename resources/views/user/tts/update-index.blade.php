...
<link href="/plugins/audio-player/green-audio-player.css" rel="stylesheet">
    ...
    <style>
        ...
        *, :after, :before {
        ...
        .audio-textarea::selection {
            color: #FFF; /* WebKit/Blink Browsers */
            background: #5579AC;
        }
        .audio-textarea::-moz-selection {
        ...
        .layer-tooltip button svg {
            fill: #FFF;
        }
        .layer-tooltip  button:hover svg {
            fill: #000;
        }
        .popup-btn-delete svg{
        ...
        .popup-btn-delete:hover svg{
            fill: #FF0000 !important;
        }

        .popup-volume-slide-container {
            width: 100%;
        }
        .popup-volume-slider {
        ...
        <div class="editor-col">
            ...
            <div class="editor-wrap">
                ...
                <div class="audio-textarea-wrap">
                    ...
                    <div class="audio-textarea form-control scope-four" id="audio-textarea" contenteditable="true">{{ Session::get('user_text') }}</div>
                    ...
                    <div class="track-list-wrap" v-if="trackType == 'music'">
                        ...
                        <div class="pagination col-12">
                            <ul class="pagination">
                                ...
                                {{-- <li class="pagination-item">
                                  <a href="#" @click.prevent="onClickPreviousPage" :class="backgroundMusicisInFirstPage? 'disabled':''" :disabled="backgroundMusicisInFirstPage">«</a>
                                </li> --}}
                                ...
                                {{-- <li class="pagination-item">
                                  <a href="#" @click.prevent="onClickNextPage" :class="backgroundMusicisInLastPage? 'disabled':''" :disabled="backgroundMusicisInLastPage">»</a>
                                </li> --}}
                                <li class="pagination-item">
            ...
            <div class="modal-content" style="background:#353B5A">
                ...
                <div class="modal-body">        
                    ...
                    <div class="text-center">
                        <button class="btn play-project" @click="trimAudioUpdate()" v-if="!trimPreviewIsPlaying">
                            Trim          
                        </button>
