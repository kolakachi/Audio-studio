...
<?php function extra_head(){ ?>
    ...
    <link rel="preload" href="<?php echo "static/css/style-main.css"; ?>" type="text/css" media="screen" as="style" />
    <link rel="stylesheet" href="<?php echo "static/css/style-main.css"; ?>" type="text/css" media="screen" />
                        ...
                        <div class="elem">
                            <div class="elem-img-wrap">
                                <img class="lazyload" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII="
                                    data-src="<?php echo 'static/img/headphone.svg'; ?>" alt="Audio">
                            </div>
                            ...
                            <button class="btn btn-primary btn-sidebar-move"
                                data-path="<?php echo "static/".$path; ?>"
        ...
        <div class="main custom-scroll">
            ...
            <div class="d-flex main-audio custom-scroll">
                ...
                <div class="empty-wrap">
                    <img class="lazyload" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+ip1sAAAAASUVORK5CYII="
                        data-src="<?php echo 'static/img/ghost.svg'; ?>" alt="Nothing added to play area">
...
<?php function extra_body(){ ?>
    ...
    <script async src="<?php echo "static/js/interact.js"; ?>"></script>
    <script async src="<?php echo "static/js/tkd_script.js"; ?>"></script>
    <script async src="<?php echo "static/js/main.js"; ?>"></script>
